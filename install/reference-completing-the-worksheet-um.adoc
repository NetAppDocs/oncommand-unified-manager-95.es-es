...
| Sistema en el que se ha puesto en marcha el software | Su valor 
 ...
 a| 
Dirección IP del servidor ESXi (solo VMware)
 a| 
...
Metadatos del proveedor de identidades (IDP)
 ...
 a| 
Dirección IP del host de destino de capturas SNMP
 a| 
...
Los detalles de los sistemas de almacenamiento que gestionará mediante Unified Manager.
